...
"}")
        ...
        self.homeButton.setLayout(QtWidgets.QGridLayout())
...
"")
        ...
        self.uploadButton = QtWidgets.QPushButton(self.frame_7)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("assets/img/upload.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uploadButton.setIcon(icon6)
        self.uploadButton.setIconSize(QtCore.QSize(24, 24))

        self.uploadButton.setMinimumSize(QtCore.QSize(0, 30))
        self.uploadButton.setMaximumSize(QtCore.QSize(16777215, 30))
